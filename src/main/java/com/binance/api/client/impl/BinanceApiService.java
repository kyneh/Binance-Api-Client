...
public interface BinanceApiService {
    ...
    Call<DustTransferResult> dustTransfer(@Query("asset") List<String> asset, @Query("recvWindow") Long recvWindow, @Query("timestamp") Long timestamp);
  ...
  // User stream endpoints
    ...
    Call<LeftDailyPurchaseQuota> getLeftDailyPurchaseQuota(
    ...
    Call<PurchaseFlexibleProductResponse> purchaseFlexibleProduct(
            @Query("productId") String productId,
    ...
    Call<LeftDailyRedemptionQuota> getLeftDailyRedemptionQuota(
            @Query("productId") String productId,
            @Query("type") RedemptionType type,
            @Query("recvWindow") Long recvWindow,
            @Query("timestamp") Long timestamp);

    @Headers(BinanceApiConstants.ENDPOINT_SECURITY_TYPE_SIGNED_HEADER)
    @POST("/sapi/v1/lending/daily/redeem")
    Call<Void> redeemFlexibleProduct(
            @Query("productId") String productId,
            @Query("amount") String amount,
            @Query("type") RedemptionType type,
            @Query("recvWindow") Long recvWindow,
